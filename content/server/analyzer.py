...
def update_portfolio(conn):
    ...
    for row in c.execute("select * from assets").fetchall():
        ...
        query_string = "update assets set sentiment={}, price={}, shares={} where ticker='{}'".format(
            new_sentiment, ticker_price, new_shares, ticker)
    ...
    history_query = "insert into history values('{}', {}, {}, {}, {}, {}, {}, {})".format(
        current_time, last_value, current_value, last_sent, current_sentiment, value_change, sentiment_change, num_invested)
...
def initialize_portfolio():
    ...
    history_query = "insert into history values('{}', {}, {}, {}, {}, {}, {}, {})".format(
        current_time, current_value, current_value, current_sentiment, current_sentiment, 0, 0, num_invested)
    c.execute(history_query)
    conn.commit()
